...
INSERT INTO pensions (employee_id)  SELECT employee_number FROM (   SELECT *  FROM employees   LEFT JOIN pensions   ON pensions.employee_id = employees.employee_number ) AS t1 WHERE t1.id IS NULL LIMIT 1;
